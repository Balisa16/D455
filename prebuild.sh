...
cp -rf assets/cmake_temp/cmake4.txt thirdparty/librealsense/CMakeLists.txt
cp -rf assets/cmake_temp/install_config.cmake thirdparty/librealsense/CMake/install_config.cmake